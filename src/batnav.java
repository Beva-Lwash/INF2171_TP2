...
public class batnav {
	...
	*//**
		 ...
		 *//*
			 ...
			 * horizontal char v = 'v'; // vertical // TODO crÃƒÂ©ÃƒÂ©r tableau char[][]
			 ...
			 * rangÃƒÂ©e[1-9] puis un espace // Pep8.charo('\n'); Pep8.stro(Colonnes);
			 * Pep8.charo('\n');
			 * 
			 * for (int i = 0; i <= 8; i++) { Pep8.deco(i + 1); Pep8.charo('|'); for (int j
			 * = 0; j <= 17; j++) { Pep8.charo(matrice[i][j]); } Pep8.charo('|');
...
public class batnav {
	...
	Pep8.stro("Vous avez coulé tous les bateaux !!!!!! Yahoooooooo!!!!");
